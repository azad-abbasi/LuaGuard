			...
			switch (alt9) {
				case 1 :
					...
					// 267:21: -> ^( FUNCTION_ASSIGNMENT ^( VAR_LIST ) ^( EXPR_LIST func_body ) )
					{
						...
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(VAR_LIST, "VAR_LIST"), root_2);
						adaptor.addChild(root_2, namesToVar((names65!=null?((names_return)names65).list:null), (Name67!=null?Name67.getText():null)));
						adaptor.addChild(root_1, root_2);
						}
				...
				case 2 :
					...
					// 269:21: -> ^( FUNCTION_ASSIGNMENT ^( VAR_LIST ) ^( EXPR_LIST func_body ) )
					{
						...
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot((CommonTree)adaptor.create(VAR_LIST, "VAR_LIST"), root_2);
						adaptor.addChild(root_2, namesToVar((names65!=null?((names_return)names65).list:null)));
						adaptor.addChild(root_1, root_2);
						}
